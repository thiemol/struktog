...
const translations = {
  ...
  es: {
    ...
    nodes: {
      ...
      FunctionNode: 'Bloque de función'
    },
    nav: {
      unnamed: 'sin título',
    ...
    editor: {
      ...
      enableDefaultBranch: 'Activar rama else:',
