    ...
    if (subTree === null) {
      ...
      switch (subTree.type) {
        ...
        case "BranchNode": {
          ...
          divFalse.setAttribute("data-branch-side", "false");
          for (const elem of this.renderElement(
            subTree.falseChild,
            false,
            noInsert
        ...
        case "CountLoopNode": {
          ...
          divLoop.setAttribute("data-loop-body", "true");
          divLoop.setAttribute("data-node-id", subTree.id);
